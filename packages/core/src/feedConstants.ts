...
export const NOTES_DESKTOP = 60;       // notes per query on desktop
export const NOTES_MOBILE = 25;        // notes per column on mobile
export const FETCH_MORE_COUNT = 60;    // notes to fetch on "load older"
