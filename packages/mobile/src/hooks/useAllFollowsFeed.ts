/**
 * useAllFollowsFeed — Fetch notes from all contacts using batch queries.
 *
 * Ported from packages/web/src/hooks/useAllFollowsFeed.ts.
 * Uses the mobile NostrProvider for fetching.
 */
