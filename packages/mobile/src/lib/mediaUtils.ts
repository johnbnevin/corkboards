// ─── CORS HEAD whitelist ─────────────────────────────────────────────────
// Hosts known to support HEAD requests for size checking. Only these get
// pre-checked for file size. All other hosts skip the HEAD and show a
// placeholder instead.
...
/** True if the host is known to support HEAD requests for size checking */
...
/** Mark a host as HEAD-capable after a successful response */
