/**
 * Renders a display name with NIP-30 custom emoji support.
 * Replaces :shortcode: patterns with <img> tags using emoji tags from the profile event.
 */
...
export function EmojiName({ name, event, className }: EmojiNameProps) {
  const parts = useMemo(() => {
